<body class="app">    
		    ...
		    <div class="container-xl">
                ...
                <div class="app-card app-card-accordion shadow-sm mb-4">
				    <div class="app-card-header p-4 pb-2  border-0">
				       <h4 class="app-card-title">Servicios</h4>
				    </div><!--//app-card-header-->
						    ...
						    <div class="accordion-item">
							    <h2 class="accordion-header" id="faq1-heading-1">
							      <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse"  data-bs-target="#faq1-1" aria-expanded="false" aria-controls="faq1-1">
							        Cómo contactarme con un prestador?
							      </button>
							    </h2>
							    <div id="faq1-1" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-1">
							        <div class="accordion-body text-start p4">
							            Tendrás que ingresar a los detalles del producto y en el botón que dice "Contactar" te redireccionará a un chat en donde podrás hablar con el prestador.
							        </div>
							    </div>
							</div><!--//accordion-item-->      
	                    </div><!--//faq1-accordion-->
					    ...
					    <div id="faq2-accordion" class="faq2-accordion faq-accordion accordion">
                            <div class="accordion-item">
							    ...
							    <div id="faq2-1" class="accordion-collapse collapse border-0" aria-labelledby="faq2-heading-1">
							        <div class="accordion-body text-start p4">
							            Una vez ingreses sesión, en la parte superior derecha verás un botón de configuracion, ingresa ahí y podrás cambiar tus datos, mejorar tu plan y activar o desactivar notificaciones.
							        </div>
							    </div>
							</div><!--//accordion-item-->
				...
				<div class="app-card app-card-accordion shadow-sm mb-4">
				    <div class="app-card-header p-3">
				       <h4 class="app-card-title">Medios de pago</h4>
				    </div><!--//app-card-header-->
				    <div class="app-card-body p-4 pt-0">
                            ...
                            <div class="accordion-item">
							    <h2 class="accordion-header" id="faq3-heading-1">
							      <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse"  data-bs-target="#faq3-1" aria-expanded="false" aria-controls="faq3-1">
							        Cuáles medios de pago hay?
							      </button>
							    </h2>
							    <div id="faq3-1" class="accordion-collapse collapse border-0" aria-labelledby="faq3-heading-1">
							        <div class="accordion-body text-start p4">
							            Actualmente contamos con tres medios de pago, entre ellos está tarjeta de crédito, efectivo con el prestador y transferencia bancaria.
							        </div>
							    </div>
							</div><!--//accordion-item-->
  ...
  <path d="M6.5 14a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2h-1a1 1 0 0 1-1-1z"/>
							        ...
							        <div class="col-auto">
								        <h4 class="app-card-title">Necesita más ayuda?</h4>
							        </div><!--//col-->
						        </div><!--//row-->
						    </div><!--//app-card-header-->
						    <div class="app-card-body px-4">
							    <div class="intro mb-3">Contáctenos a nuestro correo o línea de atención para un servicio de ayuda más específico.</div>
							    <ul class="list-unstyled">
								    <li><strong>Tel:</strong> 300 323 8106</li>
								    <li><strong>Email:</strong> <a href="#">quickfix@quickfix.co</a></li>
							    </ul>
						    </div><!--//app-card-body-->
						</div><!--//app-card-->
					</div><!--//col-->
  ...
  <path fill-rule="evenodd" d="M14.43 10.772l-2.788-1.115a4.015 4.015 0 0 1-1.985 1.985l1.115 2.788a7.025 7.025 0 0 0 3.658-3.658zM5.228 14.43l1.115-2.788a4.015 4.015 0 0 1-1.985-1.985L1.57 10.772a7.025 7.025 0 0 0 3.658 3.658zm9.202-9.202a7.025 7.025 0 0 0-3.658-3.658L9.657 4.358a4.015 4.015 0 0 1 1.985 1.985l2.788-1.115zm-8.087-.87L5.228 1.57A7.025 7.025 0 0 0 1.57 5.228l2.788 1.115a4.015 4.015 0 0 1 1.985-1.985zM8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm0-5a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
							        ...
							        <div class="col-auto">
								        <h4 class="app-card-title">Quiere mejorar su plan?</h4>
							        </div><!--//col-->
						        </div><!--//row-->
						    </div><!--//app-card-header-->
						    <div class="app-card-body px-4">
							    
							    <div class="intro mb-3">Obtendrás mejores beneficios como prestador de servicio con este plan.</div>
							    <ul class="list-unstyled">
								    <li>
	  ...
	  <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/>
                                        ...
                                        Mejor posicionamiento de su publicación.
                                    </li>
                                    <li>
									    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check2 text-primary me-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	  <path fill-rule="evenodd" d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/>
						    ...
						    <div class="app-card-footer p-4 mt-auto">
								<?php
									if(!verificaAutenticacion()){
										echo '<a href="#" class="btn app-btn-primary" data-bs-toggle="modal" data-bs-target="#autenticar">Mejorar Ahora</a>';
									}else{
										echo '<a  href="index.php?informacion=configuracion">Mejorar ahora</a>';
									}
								?>
						    </div><!--//app-card-footer-->
						</div><!--//app-card-->
