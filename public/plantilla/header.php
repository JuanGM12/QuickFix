<body class="app">   	
						        ...
						        <div class="dropdown-menu-content">
							       <div class="item p-3">
								        <div class="row gx-2 justify-content-between align-items-center">
									        ...
									        <div class="col">
										        <div class="info"> 
											        <div class="desc">Amy sharedd a file with you. Lorem ipsum dolor sit amet, consectetur adipiscing elit. </div>
  ...
  <path fill-rule="evenodd" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/>
						        ...
						        <div class="dropdown-menu-footer p-2 text-center">
							        <a href="?informacion=notificaciones">View all</a>
						        </div>
															
							</div><!--//dropdown-menu-->					        
				        </div><!--//app-utility-item-->
			            <div class="app-utility-item">
				            <a href="?informacion=configuracion" title="Settings">
					            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            ...
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								...
								<li><a class="dropdown-item" href="?informacion=configuracion">Settings</a></li>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="/plantilla/images/app-logo.svg" alt="logo"><span class="logo-text">PORTAL</span></a>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="?informacion=notificaciones">Notifications</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="account.html">Account</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="?informacion=configuracion">Settings</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->
					    <li class="nav-item has-submenu">
			    ...
			    <div class="app-sidepanel-footer">
				    <nav class="app-nav app-nav-footer">
					    <ul class="app-menu footer-menu list-unstyled">
						    <li class="nav-item">
						        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
						        <a class="nav-link" href="?informacion=configuracion">
							        <span class="nav-icon">
